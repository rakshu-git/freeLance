 ...
 <div className="place-card" id="places" style={{backgroundColor:"#F0F2F5"}}>
            ...
            <div  className='card'>
                ...
                <div className='card-box '>
                        <img src="https://2.bp.blogspot.com/-8XqNNCF-5wI/V0ptdu5tZ6I/AAAAAAAACZ4/_rbbN8zX2cksGjbeZEHeiFW8LQW_KTO6QCLcB/s640/IMG-20151228-00663.jpg" alt="chibbalgudde fish" height="200" width="350" />
                ...
                <div className='card-box'>
                    <img src="http://2.bp.blogspot.com/_1hVeI0YTvR0/S-LcJyByDVI/AAAAAAAAA1U/24jR-0u0uxo/s1600/kavimane-1.jpg" alt="Kuvempu mane" height="200" width="350" />
                ...
                <div className='card-box'>
                    <img src="https://tse2.mm.bing.net/th?id=OIP.P_OQAR-9e0SvmnvI98ACkAAAAA&pid=Api&P=0&h=180" alt="hariharapura mata" height="200" width="350" />
                ...
                <div className='card-box resCard'>
                    <img src="https://im.whatshot.in/img/2022/Apr/7-cropped-1650633365.jpg" alt="kundadri hills" height="200" width="350" />
                ...
                <div className='card-box resCard'>
                    <img src="https://jainsattva.com/wp-content/uploads/2024/06/Varanga-Jain-Temple-920x613.jpg" alt="Varanga" height="200" width="350" />
                ...
                <div className='card-box resCard space '>
                    <img src="https://static2.tripoto.com/media/filter/nl/gen/33768/TripDocument/11870778_932433260136121_8560877187230413735_n.jpg" alt="kundadri hills" height="200" width="350" />
